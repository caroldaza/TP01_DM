...
```
Hay filas 25428 repetidas.

```{r}
sub_audio_features2 <-sub_audio_features[c(2,15,18,21,26,27,30,31,32,40)]
sub_audio_features2_max<-apply(sub_audio_features2,2,max)
sub_audio_features2 <- sub_audio_features2/sub_audio_features2_max
names(sub_audio_features2)
```
31 27
```{r}
boxplot(sub_audio_features2,main="Boxplots audio features",las=2)
```
